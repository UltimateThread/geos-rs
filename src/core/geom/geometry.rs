...
impl Geometry {
    pub const TYPECODE_POINT: i32 = 0;
    pub const TYPECODE_MULTIPOINT: i32 = 1;
    pub const TYPECODE_LINESTRING: i32 = 2;
    pub const TYPECODE_LINEARRING: i32 = 3;
    pub const TYPECODE_MULTILINESTRING: i32 = 4;
    pub const TYPECODE_POLYGON: i32 = 5;
    pub const TYPECODE_MULTIPOLYGON: i32 = 6;
    pub const TYPECODE_GEOMETRYCOLLECTION: i32 = 7;

    pub const TYPENAME_POINT: &'static str = "Point";
    pub const TYPENAME_MULTIPOINT: &'static str = "MultiPoint";
    pub const TYPENAME_LINESTRING: &'static str = "LineString";
    pub const TYPENAME_LINEARRING: &'static str = "LinearRing";
    pub const TYPENAME_MULTILINESTRING: &'static str = "MultiLineString";
    pub const TYPENAME_POLYGON: &'static str = "Polygon";
    pub const TYPENAME_MULTIPOLYGON: &'static str = "MultiPolygon";
    pub const TYPENAME_GEOMETRYCOLLECTION: &'static str = "GeometryCollection";
