...
impl LineSegment {
  ...
  pub fn getCoordinate(&self, i: usize) -> Coordinate {
    if i == 0 { return self.p0; }
    return self.p1;
  }

  pub fn setCoordinatesFromLineSegment(&mut self, ls: LineSegment) {
    self.setCoordinates(&ls.p0, &ls.p1);
  }

  pub fn setCoordinates(&mut self, p0: &Coordinate, p1: &Coordinate) {
    self.p0.x = p0.x;
    self.p0.y = p0.y;
    self.p1.x = p1.x;
    self.p1.y = p1.y;
   ...
   */
  pub fn isHorizontal(&self) -> bool { return self.p0.y == self.p1.y; }
   ...
   */
  pub fn isVertical(&self) -> bool { return self.p0.x == self.p1.x; }
   ...
   */
  pub fn orientationIndex(&self, seg: &LineSegment) -> i32 {
