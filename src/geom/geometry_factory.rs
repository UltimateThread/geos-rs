...
use super::precision_model::PrecisionModel;
...
//     return GeometryFactory::createPointFromCoordinateArraySequence(&coord_seq);
// }

// // pub fn createPointPacked() -> Point {
// //     let coords: Vec<Coordinate> = vec![];
// //     return createPoint(PackedCoordinateSequenceFactory::create_double_from_coordinates(&coords));
// // }
...
// */
// pub fn createPointFromCoordinate(coordinate: &Coordinate) -> Point {
//     let coords: Vec<Coordinate> = vec![Coordinate::from_coordinate(&coordinate)];
//     return GeometryFactory::createPointFromCoordinateArraySequence(&CoordinateArraySequenceFactory::create_from_coordinates(&coords));
//     }
...
// * @return the created Point
// */
// pub fn createPointFromCoordinateArraySequence(coordinates: &CoordinateArraySequence) -> Point {
